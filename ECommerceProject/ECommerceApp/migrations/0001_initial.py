    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ImageTypeID', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ECommerceApp.imagetype')),
            ],
        ),
        migrations.CreateModel(
            name='MenuDetail',
            fields=[
                ...
                ('MenuID', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ECommerceApp.menu')),
            ],
        ),
    ]
