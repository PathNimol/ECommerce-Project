    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoryID', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ECommerceApp.category')),
            ],
        ),
        migrations.CreateModel(
            name='ProductDetail',
            fields=[
                ...
                ('productID', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ECommerceApp.product')),
            ],
        ),
        migrations.CreateModel(
